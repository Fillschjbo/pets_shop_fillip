const s="7c5e4be3-e45e-4b27-98b8-076dd2b13f1a",t="https://v2.api.noroff.dev/",c=`${t}pets`,i=`${t}auth/register`,u=`${t}auth/login`;function a(){localStorage.removeItem("token"),localStorage.removeItem("user"),document.location.reload()}const o=document.querySelector(".login-btn"),n=document.querySelector(".menu"),r=document.querySelector(".fixed");function g(){localStorage.getItem("token")?(o.innerHTML=`
        ...
        `,n.innerHTML=`
            ...
            `)}const l=document.querySelector("button");l.addEventListener("click",()=>{r.classList.toggle("scale-y-100"),r.classList.toggle("scale-y-0")});document.addEventListener("click",e=>{e.target.classList.contains("logout")&&a()});export{u as A,i as a,c as b,s as c,g as h};
